...
(async () => {
  ...
  try {
    ...
    // Categories
    const catPortable = await upsert(
      catModel,
      { slug: "portable" },
      { name: "Portable", slug: "portable", publishedAt: new Date() },
    );
    const catKaraoke = await upsert(
      catModel,
      { slug: "karaoke" },
      { name: "Karaoke", slug: "karaoke", publishedAt: new Date() },
    );
    ...
    await upsert(
      ...
      {
        question: "Thời lượng pin?",
        answer: "Tối đa 8-10 giờ tùy model",
        product: 1,
        publishedAt: new Date(),
      },
    );
    ...
    await ensureProductImage(
      "ba-mini",
      "https://picsum.photos/seed/ba-mini/800/600",
      "ba-mini.jpg",
    );
    await ensureProductImage(
      "ba-k1",
      "https://picsum.photos/seed/ba-k1/800/600",
      "ba-k1.jpg",
    );
