...
export default function WishlistPageClient() {
  ...
  if (wishlist.itemCount === 0) {
    return (
      <div className="bg-darkGrey/60 border border-darkGrey rounded-2xl p-12 text-center backdrop-blur-sm">
        <div className="w-16 h-16 mx-auto mb-4 text-textGrey">
        ...
        <Link
          href="/products"
          className="inline-block rounded-2xl bg-goldAccent px-6 py-3 text-darkBg font-semibold hover:shadow-glowGoldHover transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-goldAccent focus:ring-offset-2 focus:ring-offset-darkBg"
        >
          Khám phá sản phẩm
        </Link>
      </div>
  ...
  return (
    <div className="space-y-6">
      {/* Actions Bar */}
      <div className="bg-darkGrey/60 border border-darkGrey rounded-2xl p-4 backdrop-blur-sm">
            ...
            <div className="space-y-3">
              <div>
                <Link
                  ...
                  className="font-medium text-textWhite hover:text-neonTurquoise line-clamp-2 transition-colors"
                >
                  {item.title}
                </Link>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 rounded-2xl bg-goldAccent text-darkBg py-2 text-sm font-semibold hover:shadow-glowGoldHover transition-all duration-300 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-goldAccent focus:ring-offset-2 focus:ring-offset-darkBg"
                >
                  Thêm vào giỏ
                </button>
                <Link
                  href={`/products/${item.slug}`}
                  className="flex-1 rounded-2xl border border-darkGrey text-textWhite py-2 text-sm font-medium text-center hover:bg-darkGrey/60 transition-colors focus:outline-none focus:ring-2 focus:ring-neonTurquoise focus:ring-offset-2 focus:ring-offset-darkBg"
                >
                  Xem chi tiết
                </Link>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded-2xl bg-neonTurquoise text-darkBg px-3 py-2 text-sm font-semibold hover:brightness-110 transition-colors focus:outline-none focus:ring-2 focus:ring-neonTurquoise focus:ring-offset-2 focus:ring-offset-darkBg"
                  >
                    Copy
                  </button>
                </div>
