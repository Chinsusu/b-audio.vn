      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="text-textGrey text-lg mb-8">
            Our e-commerce checkout system is currently under development. 
            For now, please contact us directly for purchases.
          </div>
          <div className="bg-cardBg/40 backdrop-blur-sm border border-darkGrey rounded-2xl p-8 mb-8">
            <h2 className="text-2xl font-bold text-goldAccent mb-4">How to Order</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="text-textGrey">
              ...
              <a href="mailto:info@b-audio.vn" className="text-goldAccent hover:text-goldAccent/80">
                info@b-audio.vn
              </a>
            </div>
          </div>
