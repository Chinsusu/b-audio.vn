  ...
  const loadMoreReviews = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/reviews/${productId}?page=${page + 1}&limit=5`,
      );
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {reviews.map((review) => (
          <div
            key={review.id}
            className="bg-white rounded-2xl border border-cloud p-6"
          >
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L9 7v13m-3-4h-2m0-2h2m-2-2h2m2-3l-2 2 2 2"
                    />
                  </svg>
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M10 14H5.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.736 3h4.018c.163 0 .326.02.485.06L17 4m-7 10v2a2 2 0 002 2h.095c.5 0 .905-.405.905-.905 0-.714.211-1.412.608-2.006L15 17V4m-3 4H9m2 2H9m2 2H9m2-3l2-2-2-2"
                    />
                  </svg>
                  Không
                </button>
