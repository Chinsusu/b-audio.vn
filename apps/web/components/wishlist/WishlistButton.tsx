...
export default function WishlistButton({ 
  ...
  if (variant === 'button') {
    return (
      <button
        ...
        className={`flex items-center gap-2 rounded-xl px-4 py-2 font-medium transition-all duration-200 disabled:opacity-50 ${
          inWishlist 
  ...
  return (
    <button
      onClick={handleToggle}
      disabled={isLoading} aria-busy={isLoading}
      className={`${sizeClasses[size]} rounded-xl flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 disabled:opacity-50 ${
        inWishlist 
